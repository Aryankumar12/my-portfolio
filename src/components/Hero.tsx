...
const Hero = () => {
  ...
  >
    {/* Left Div */}
    <div className="flex-1 text-center md:text-left p-5 md:ml-20">
      ...
      <div className="space-y-4 md:space-y-0 space-x-0 md:space-x-4">
        ...
        {/* Contact Me Button */}
        <button
          className="w-full md:w-auto px-6 py-3 bg-white text-gray-800 font-semibold rounded-lg border-2 border-black shadow-[8px_8px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-all" onClick={()=> document.getElementById("contactus")?.scrollIntoView({behavior:"smooth"})}
    ...
    <div className="flex-1 flex justify-center items-center p-5">
      <div className="bg-white shadow-[10px_10px_0px_1px_rgba(0,0,0,0.75)] rounded-full p-5">
        <Image src={profilePicture} alt='profile-picture' className="rounded-full h-80 w-80 object-cover md:h-96 md:w-96">
